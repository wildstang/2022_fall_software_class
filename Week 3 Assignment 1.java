...
//of phrases and numbers to be divisible by, and use them to run the same exercise for an
//unknown number of phrases. Fill in the answers array the same as before for every number from 
//1 until length
