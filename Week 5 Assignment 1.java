...
DigitalInput button = (DigitalInput) Core().getInputManager().getInput(WsInputs.DRIVER_FACE_DOWN);
...
//deadbandValue = (value - deadband) * 100 / (100 - deadband)

double deadband = 0.1;
AnalogInput joystick = (AnalogInput) Core().getInputManager().getInput(WsInputs.DRIVER_LEFT_JOYSTICK_Y);
